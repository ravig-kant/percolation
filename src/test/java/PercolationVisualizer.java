...
public class PercolationVisualizer{
    ...
    private String file = "C:\\Users\\ravigu\\Coursera\\Algorithms\\Assignments\\QuickUnion\\Test\\percolation\\snake13.txt";
    ...
    @Test
    public void test() {
        Path path = Paths.get("C:\\Users\\ravigu\\Coursera\\Algorithms\\Assignments\\QuickUnion\\Test\\percolation");
        try (DirectoryStream<Path> directoryStream = Files.newDirectoryStream(path, "*.txt")) {
            ...
            Logger.getLogger(PercolationVisualizer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
